...
print("-----------------------------------------------------------------------------------")
for i in range(n,k):
    print(i,"             | ",Obyom_cilindra(i),"   | ", Ploshad_kruga(i)*i," | ",Obyom_cilindra(i) == Ploshad_kruga(i)*i)
    fact3.append(Obyom_cilindra(i))
    expec3.append(Ploshad_kruga(i)*i)
    if (Obyom_cilindra(i) == Ploshad_kruga(i)*i)==False:
        x3.append(i)
